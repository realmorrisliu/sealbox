...
Every endpoint other than the health probes SHALL require authentication, and SHALL reject
unauthenticated requests without disclosing whether the requested resource exists.
